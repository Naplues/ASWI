...
U_data <- read.csv('C:/Users/gzq10/Desktop/Git/SAWI/analysis/ANTERIOR-First.csv', header = TRUE)
P_data <- read.csv('C:/Users/gzq10/Desktop/Git/SAWI/analysis/Supervised-B_p.csv', header = TRUE)
R_data <- read.csv('C:/Users/gzq10/Desktop/Git/SAWI/analysis/Supervised-B_r.csv', header = TRUE)
F_data <- read.csv('C:/Users/gzq10/Desktop/Git/SAWI/analysis/Supervised-B_f.csv', header = TRUE)
...
write.table(result, '../analysis/RQ1-p-value.csv', row.names = FALSE, sep = ',')
...
result <- data.frame(name, data_p, data_r, data_f)
write.table(result, '../analysis/RQ1-cliff.csv', row.names = FALSE, sep = ',')
...
result <- data.frame(name, data_p, data_r, data_f)
write.table(result, '../analysis/RQ1-power.csv', row.names = FALSE, sep = ',')
